...
def score_risk(signals: Dict) -> Dict:
    ...
    return {
        ...
        "scoring_model": {
            ...
            "content_penalty_points": content_penalty_points,
            "infra_penalty_points": infra_penalty_points,
            "interaction_penalty_points": combo_points,
            "total_penalty_points": total_penalty,
            "final_score": final_score,
            "formula": "final_score = baseline_score - total_penalty_points",
        },
        "breakdown": breakdown,
        "findings": findings,
